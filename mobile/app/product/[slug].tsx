...
export default function ProductScreen() {
  ...
  const addToCart = async () => {
    if (!variantId) return Alert.alert('Sin existencias', 'Este producto no tiene una variante disponible.')
    setAdding(true)
    try { await add(variantId); Alert.alert('Añadido al carrito', 'Puedes continuar explorando o revisar tu carrito.') }
    catch { Alert.alert('No fue posible añadirlo', 'Inténtalo nuevamente.') }
